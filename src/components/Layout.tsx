...
export const Layout = ({
  ...
  return (
    <div className="min-h-screen p-2 inset-0  flex flex-col justify-center items-center">
      <div className="lg:w-5/14 w-full grid grid-cols-1 grid-rows-1 place-content-center relative">
        <img className="absolute size-10 z-10  -top-10 right-20 " src={amph} />
        <main className=" lg:px-20 h-full lg:py-12 px-10 py-8 overflow-y-scroll p-2 relative  rounded-3xl outline outline-2 relative gap-10 lg:gap-20 w-full flex flex-col items-center justify-center bg-neutral-100">
          {children}
        </main>
